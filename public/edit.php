...
if (isset($_GET['id'])){
    ...
    if ($_SESSION['role'] === 'admin' or is_author($_SESSION['current_user_id'], $editedUserId)) {
        $user = get_user_by_id($editedUserId);
        if (!$user){
            setFlashMessage('danger', 'Пользователь не найден');
        ...
        setFlashMessage('danger', 'Не указан ID пользователя');
        redirectTo('users.php');
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="process_edit.php" method="post">
            <input type="hidden" name="id" value="<?php echo $editedUserId; ?>">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" value="<?php echo $user['username']; ?>" name="username">
                                </div>

                                <!-- title -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Место работы</label>
                                    <input type="text" id="simpleinput" class="form-control" value="<?php echo $user['job_title']; ?>" name="job_title">
                                </div>
